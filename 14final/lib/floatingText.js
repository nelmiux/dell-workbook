var FloatingText = function(state, options) {
  ...
  function createFloatingText(store) {
    ...
    if (_sprite === null) {
      ...
      _obj.anchor.setTo(_spriteAnchor);
      _obj.animations.add(
        _spriteAnimationName,
        _spriteAnimationFrames,
        _spriteAnimationFrameRate,
        _spriteAnimationRepeat,
        true
      );
    }
  ...
  function animateFloatingText() {
    ...
    if (type === 'physics') {
      ...
      tweenProperty(
        floatingTextGroup.position,
        'position',
        {
          x: floatingTextGroup.position.x - scaleX / 2,
          y: floatingTextGroup.position.y - scaleY / 2
        },
        250,
        0,
        Phaser.Easing.Back.Out
